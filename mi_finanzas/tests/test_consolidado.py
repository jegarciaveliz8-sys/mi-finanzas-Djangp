...
class FinanzasLogicTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # 2. Crear cuentas (Usando 'saldo' en lugar de 'balance')
        ...
        # ... (Asegúrate de que este setup esté completo si lo necesitas) ...
    ...
    def test_transferencia_correcta_actualiza_ambos_saldos(self):
        ...
        # CORRECCIÓN: Se añade el campo 'fecha' para evitar IntegrityError
...
class PanelDeControlTest(TestCase):
    ...
    def test_anadir_transaccion_con_post(self):
        ...
        # CORRECCIÓN: Se usa 'anadir_transaccion' (el nombre real en urls.py)
        url_crear = reverse('mi_finanzas:anadir_transaccion') # ✅ Corrección
